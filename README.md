...
| www.amazon.ae <br> www.amazon.eg <br> www.amazon.sa |[🔗](https://github.com/deepak4u/Web-Scraping/blob/main/Notebooks/Amazon_Category_Crawl_Final.py) <br><br><br> [🔗](https://github.com/deepak4u/Web-Scraping/blob/main/Notebooks/amazon_category_crawl_product_detail_final.py) | Amazon Category crawl with different level of mapping. <br>**Params:** cat_level_name (breadcrumbs style store), cat_level_url, etc. <br><br>  Amazon products crawl under categories. <br>**Params:** prod_name,prod_url, prod_url_asin, price, badge_text etc.
